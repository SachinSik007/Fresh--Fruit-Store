...
import Fruit3 from "../../assets/Avacado.jpeg";
import Fruit4 from "../../assets/Banana.png";
        ...
        <div className="container pt-12 pb-20">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
            {MenusData.map((menu, index)=>(
                ...
                className="bg-white rounded-3xl px-4 py-2 shadow-[0_0_22px_0_rgba(0, 0, 0, 0.15)] flex flex-row justify-around items-center gap-3" key={index}>
